...
<b>NOTE</b>: As of 2026-May, location data is no longer available via grpc for most service plans, so the following instructions likely won't do anything useful.
